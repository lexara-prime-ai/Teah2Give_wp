...
function story_teller_theme_files()
{
    ...
    wp_enqueue_script('story_teller_main_script', get_theme_file_uri('/js/main.js'), null, 1.0, true);
...
//enqueue stylesheets
function story_teller_styles(){
    wp_enqueue_style( 'story_teller_main_styles', get_template_directory_uri() . '/css/styles.css', array(), 1.0);
}

add_action('wp_enqueue_scripts', 'story_teller_styles');
